...
import { trimLeadingNegatives, getWholeNumber, getDecimalNumber } from '../utils/num2Portuguese';

export function num2Portuguese(number: number | string): string {
