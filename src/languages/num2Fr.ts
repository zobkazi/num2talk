...
import { trimLeadingNegatives, getWholeNumber, getDecimalNumber } from '../utils/num2French';

export function num2French(number: number | string): string {
