...
import { trimLeadingNegatives, getWholeNumber, getDecimalNumber } from '../utils/num2Arabic';

export function num2Arabic(number: number | string): string {
