...
import { trimLeadingNegatives, getWholeNumber, getDecimalNumber } from '../utils/num2Spanish';

export function num2Spanish(number: number | string): string {
